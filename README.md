...
- `Lightbox-v1.3.2.zip`：Apple Silicon Mac，macOS 15 或更新版本。
- `Lightbox-Intel-x86-v1.3.2.zip`：Intel Mac，或需要 macOS 13 兼容版本的设备。
...
- `Lightbox-v1.3.2.zip`: Apple Silicon Macs running macOS 15 or later.
- `Lightbox-Intel-x86-v1.3.2.zip`: Intel Macs, or devices that need the macOS 13 compatible build.
